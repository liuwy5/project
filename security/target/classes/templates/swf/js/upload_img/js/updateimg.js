...
//						console.log(dataArr)
	...
	$("#showui li img.center").click(function () {
		console.log('fdf');
    });

    $("#showui img.center").click(function () {
        console.log('showui center');
    });
    ...
    // $("body").on("click", "#showui img.center", function() {
    //     alert('这里是动态元素添加的事件');
    // });
    $("#showui img.center").live("click", function () {
        alert('这里是动态元素添加的事件 live');
    });
